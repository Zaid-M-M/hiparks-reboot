...
//               </h2>
//               <p className="bw-l text-white text-[16px] leading-[25px] lg:text-[16px] lg:leading-[25px] xl:text-[20px] xl:leading-[30px]">
//                 At Horizon, we are shaping environments that work efficiently,
//                 safely, and thoughtfully for the people who use them. Our parks
//                 are designed to be human-centric: blending operational
//                 performance with smart layouts, safety-first features, and
//                 comfort-focused amenities that make a difference every day.
//               </p>
//               <a
//                 href=""
//                 className="text-[13px] leading-[22px] gap-[15px] mt-[25px] inter-sb text-white uppercase tracking-[0.1em] lg:text-[13px] lg:leading-[24px] flex items-center"
...
//                 us a competitive edge; accelerating growth, raising the bar on
//                 quality, and ensuring long-term value for our customers.
//               </p>
        ...
        <div className="w-full flex flex-col md:flex-row py-[0px] px-[0px] 1920:h-[600px] 1280:h-[550px] h-[437px]">
          <div className="w-[100%] md:w-[50%] lg:px-[70px] lg:py-[0px] py-[30px] px-[20px]  1280:h-[auto] h-[100%]  relative flex items-start md:items-center">
            <div>
              ...
              <a
                href=""
                className="text-[13px] leading-[22px] gap-[15px] xl:mt-[40px] lg:mt-[20px] mt-[25px] text-white uppercase tracking-[0.1em] lg:text-[17px] lg:leading-[26px] flex items-center bw-sb"
              >
                Integrated Business Solutions{" "}
                <img
                  className="w-[23px] md:w-[30px]"
