  ...
  return (
    <>
      ...
      >
        ...
        {/* Date Badge */}
        <div className="absolute top-4 left-4 flex items-center whitespace-nowrap gap-[5px] bg-black/25  text-white px-4 py-2 rounded-none bw-m text-[14px] xl:text-[16px] leading-[20px] border border-white/20">
