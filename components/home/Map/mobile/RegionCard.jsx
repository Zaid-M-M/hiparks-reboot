    ...
    <div className="min-w-[300px] min-h-[375px] bg-[#1A1A1A] rounded-none  shadow-lg">
      ...
      <div className="p-3">
        ...
        <h3 className="text-[25px] bw-r text-[#F47920]">
          {park.label},
          {park.city && (
            <span className="text-[18px] bw-r text-[#F47920]"> {park.city}</span>
          )}
        </h3>
        ...
        <div className="w-full text-white/80 bg-[#3C3C3C] leading-[26px] mt-2.5 px-[7px] text-sm rounded-[4px] py-[8px]">
          <div className="flex justify-between">
            <p className="bw-r bw-r text-[14px]">Total Area:</p>
            <p className="bw-r text-[15px]">{park.area}</p>
          </div>

          <div className="flex justify-between">
            <p className="bw-r bw-r text-[14px]">Potential:</p>
            <p className="bw-r text-[15px]">{park.potential}</p>
          </div>

          <div className="flex justify-between">
            <p className="bw-r bw-r text-[14px]">Certification:</p>
            <p className="bw-r text-[14px] text-right leading-[20px]">{park.certification}</p>
          </div>
        </div>
