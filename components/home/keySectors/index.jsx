    ...
    <section className="relative w-full h-full 2xl:min-h-auto overflow-hidden text-white lg:pt-[50px] 1536:pt-[80px] 1600:pt-[90px] md:pt-[50px] pt-[50px]">
      ...
      <div className="relative z-20 flex flex-col items-end justify-end w-full h-full ">
        ...
        <motion.h1
          ...
          //   ease: "easeIn",
          // }}
          className="text-[35px] md:text-[45px] lg:text-[56px] z-10 bw-m lg:leading-[65px] pb-[28px] sm:pb-0 md:leading-[58px] leading-[45px] justify-start 2xl:-mb-36 fix 2xl:pb-[30px] "
        >
          <motion.span
            initial={{ x: "-100px", opacity: 0 }}
            whileInView={{ x: "0", opacity: 1 }}
          ...
          >
            ...
            <motion.div className="relative inline-block overflow-hidden align-middle w-full max-w-[249px] h-auto">
              <motion.div
                className="lg:flex hidden justify-start h-[50px] 1366:h-[58px] overflow-hidden"
                initial={{ width: 0 }}
              ...
              <motion.div
                className="lg:hidden hidden sm:flex justify-start sm:justify-start  h-[35px] sm:h-[40px] overflow-hidden"
                initial={{ width: 0 }}
