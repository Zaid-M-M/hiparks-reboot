...
const IntegratedSolutionsSection = () => {
  return (
    <div className="relative z-0 w-full h-full lg:min-h-[650px] overflow-hidden">
      ...
      <div className="absolute bottom-[8px] hidden lg:flex right-[-50px] w-[400px] h-[400px] bg-gradient-to-tr from-[#e9f4fd] via-[#f5dce3] to-transparent rounded-full blur-2xl z-0" /> */}
      {/* <div className=""></div> */}
      <section className="relative flex flex-col h-full pt-8 md:items-end pl-[6%] pr-[5%] sm:pr-[2%] xl:pl-[max(5%,calc((100vw-1340px)/2))] md:flex-row ">
        {/* Top-left gradient */}
        {/* <div className="fix"> */}
        <div className="relative z-10 flex flex-col pb-8 1280:pb-0 justify-start md:w-full lg:min-w-[400px] 1440:min-w-[500px] flex-1 md:h-auto h-fit">
          <Header />
          <Accordion />
        </div>
