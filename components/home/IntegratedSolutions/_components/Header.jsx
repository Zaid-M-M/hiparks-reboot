...
const Header = () => {
  ...
  return (
    <div className="flex flex-col z-20 gap-[30px]">
      <div className="">
        <motion.h1
          className=" text-[36px] whitespace-nowrap overflow-hidden tracking-tight leading-[118%] lg:leading-[60px] xl:leading-[82px] 1440:leading-[125%]  md:text-[45px] lg:text-[56px] xl:text-[66px] bw-m"
          initial={{ width: 0 }}
        ...
        <motion.div className="flex items-center">
          <div className="h-[54px] md:w-[180px] w-[38vw] sm:w-[37vw] lg:w-[239px] lg:h-[80px]  lg:mr-5 ">
            <motion.h2
              ...
              className="text-[36px] whitespace-nowrap max-w-fit overflow-hidden md:text-[45px] leading-[120%] xl:leading-[68px] tracking-tighter lg:text-[56px] xl:text-[66px] bw-r"
            >
              Solutions
            </motion.h2>
          </div>
        ...
        <motion.p
          className=" w-full sm:w-fit sm:pt-[14px] pt-2 text-[16px] md:text-[20px] bw-r text-black leading-[26px] m-0"
          initial={{ opacity: 0 }}
